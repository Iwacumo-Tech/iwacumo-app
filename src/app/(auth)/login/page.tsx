...
export default function LoginPage() {
  ...
  // Shown when a Publisher/Author tries to login unverified
  ...
  const onSubmit = async (values: z.infer<typeof loginSchema>) => {
    ...
    if (res?.error === "EMAIL_NOT_VERIFIED") {
      // Determine the email to pre-fill the resend button
      // username could be an email or a username — we store it for the resend flow
      setUnverifiedEmail(
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-6">
      <div className="w-full max-w-md space-y-8">
        ...
        {/* ── Error banner: unverified Publisher/Author ─────── */}
